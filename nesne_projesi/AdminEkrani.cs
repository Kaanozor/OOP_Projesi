...
namespace nesne_projesi
{
    public partial class AdminEkrani : Form
    {
        ...
        private void BtnSatilanListele_Click(object sender, EventArgs e) // satılanları listeleme
        {
            data.baglanti();
            DataTable dt = new DataTable();
            OleDbDataAdapter da = new OleDbDataAdapter("select urunID, urunAd, urunKategori, urunRenk, urunCinsiyet, urunBeden, urunAciklama, urunFiyat, satildi from urunler Where satildi = True", data.baglan);
            da.Fill(dt);
            DgvAdmin.DataSource = dt;
        }
        ...
        private void BtnSatilmayanListele_Click(object sender, EventArgs e) // satılmayanları listeleme
        {
            data.baglanti();
            DataTable dt = new DataTable();
            OleDbDataAdapter da = new OleDbDataAdapter("select urunID, urunAd, urunKategori, urunRenk, urunCinsiyet, urunBeden, urunAciklama, urunFiyat, satildi from urunler Where satildi = False", data.baglan);
            da.Fill(dt);
            DgvAdmin.DataSource = dt;
        }
